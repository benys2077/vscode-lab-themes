...
PALETTES = {
  "quiet-light-svc-dev.json":    ("Quiet Light svc-dev",    dict(light="#a8c8ec", mid="#5b8fd6", deep="#2f5fa8", tint="#e3edf9", wash="#c9dcf3", paper="#f4f7fb", line="#e6eef8", second="#b5701f", second_soft="#f3dfc0")),
  "quiet-light-svc-prod.json":   ("Quiet Light svc-prod",   dict(light="#f0b8b0", mid="#dc7a6c", deep="#b04638", tint="#fae7e3", wash="#f3cdc7", paper="#fbf5f3", line="#f7e5e1", second="#1f7f86", second_soft="#c6e6e8")),
  "quiet-light-dev-ubuntu.json": ("Quiet Light dev-ubuntu", dict(light="#c9d9a6", mid="#8aa64a", deep="#587228", tint="#eef3e1", wash="#dde8c2", paper="#f6f8f0", line="#e9efd9", second="#7a4d9e", second_soft="#e4d5f1")),
}
def variant(label, p):
    light, mid, deep, tint, wash, paper, line, second, second_soft = (p[k] for k in ("light", "mid", "deep", "tint", "wash", "paper", "line", "second", "second_soft"))
    colors = {
      "focusBorder": mid,
      ...
      "activityBarBadge.background": second, "activityBarBadge.foreground": "#ffffff",
      ...
      "button.background": mid, "button.foreground": "#ffffff", "button.hoverBackground": deep, "badge.background": second, "badge.foreground": "#ffffff",
      ...
      "editor.findMatchBackground": second_soft, "editor.findMatchHighlightBackground": second_soft + "99",
      ...
      "editorRuler.foreground": tint, "editorCodeLens.foreground": second, "editorLink.activeForeground": deep,
    ...
    tokens = [
      ...
      {"scope": ["entity.name.function", "support.function", "meta.function-call entity.name.function"], "settings": {"foreground": second}},
      {"scope": ["entity.name.type", "entity.name.class", "support.type", "support.class"], "settings": {"foreground": deep, "fontStyle": "bold"}},
      {"scope": ["string", "string.quoted"], "settings": {"foreground": second}},
      {"scope": ["constant.numeric", "constant.language", "constant.character"], "settings": {"foreground": mid}},
      ...
      {"scope": ["entity.other.attribute-name"], "settings": {"foreground": second}},
...
DARK = {
  "lab-dark-svc-dev.json":    ("Lab Dark svc-dev",    dict(light="#24364f", mid="#5b8fd6", deep="#9cc2f2", tint="#1b2533", wash="#2c4466", paper="#171d26", line="#1f2937", second="#e0a86a", second_soft="#4a3a22")),
  "lab-dark-svc-prod.json":   ("Lab Dark svc-prod",   dict(light="#4a2622", mid="#dc7a6c", deep="#f0a89c", tint="#2a1b19", wash="#5a302a", paper="#221816", line="#2f1f1c", second="#5fc4cc", second_soft="#1f3d40")),
  "lab-dark-dev-ubuntu.json": ("Lab Dark dev-ubuntu", dict(light="#2c3a1c", mid="#8aa64a", deep="#c3d68a", tint="#1c2314", wash="#3b4a25", paper="#171b12", line="#212818", second="#b48be0", second_soft="#3a2a4c")),
}
def dark_variant(label, p):
    ...
    for k in ("titleBar.activeForeground", "activityBar.foreground", "statusBar.foreground", "tab.activeForeground", "list.activeSelectionForeground", "menu.selectionForeground"):
        c[k] = "#e6e6e6"
    c.update({"titleBar.inactiveForeground": "#e6e6e699", "activityBar.inactiveForeground": "#e6e6e688",
              "editorLineNumber.foreground": "#5f6b78", "input.background": p["tint"],
              "editorWhitespace.foreground": p["wash"], "list.hoverBackground": p["wash"] + "80"})
    swap = {"#2b2b2b": "#d4d4d4", "#8a8a82": "#7d8590"}
